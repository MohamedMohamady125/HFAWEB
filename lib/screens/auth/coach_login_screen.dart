...
class _CoachLoginScreenState extends State<CoachLoginScreen>
        ...
        if (userType != 'coach') {
          _showError(
            _languageService.getLocalizedText(
              'Access denied. Coach login only.',
              'تم رفض الوصول. تسجيل دخول المدربين فقط.',
            ),
          );
          return;
        }
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _languageService.getLocalizedText(
                                        'Access team management tools and athlete data',
                                        'الوصول إلى أدوات إدارة الفريق وبيانات اللاعبين',
                                      ),
                                      style: Theme.of(
                                        context,
                                      ).textTheme.bodyMedium?.copyWith(
  ...
  // Keep all your existing UI helper methods (_buildBackground, _buildMorphingShapes, etc.)
  // I'll just show the signature here to save space, but copy all methods from your original file
